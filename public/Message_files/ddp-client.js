...
function () {
  ...
  _proto.status = function () {
    function status() {
      ...
      return (_stream = this._stream).status.apply(_stream, arguments);
    }
  ...
  _proto.reconnect = function () {
    function reconnect() {
      ...
      return (_stream2 = this._stream).reconnect.apply(_stream2, arguments);
    }
  ...
  _proto.disconnect = function () {
    function disconnect() {
      ...
      return (_stream3 = this._stream).disconnect.apply(_stream3, arguments);
    }
